...
Revision ID: d4715c1268d9
Revises: a95374b8a12a
Create Date: 2025-09-13 09:37:57.730812
...
revision: str = 'd4715c1268d9'
down_revision: Union[str, None] = 'a95374b8a12a'
...
def upgrade() -> None:
    ...
    op.add_column('trips', sa.Column('has_budget', sa.Boolean(), server_default='false', nullable=True))
    op.drop_column('trips', 'hasBudget')
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('trips', sa.Column('hasBudget', sa.BOOLEAN(), nullable=True))
    op.drop_column('trips', 'has_budget')
