...
Revision ID: 45f1a87ec51e
Revises: bf751b7f8809
Create Date: 2025-09-13 09:48:18.825019
...
revision: str = '45f1a87ec51e'
down_revision: Union[str, None] = 'bf751b7f8809'
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('trips', sa.Column('tag_name', sa.VARCHAR(), nullable=True))
